...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d.pack(_x.goal.description.initialPose.x, _x.goal.description.initialPose.y, _x.goal.description.initialPose.theta))
      length = len(self.goal.description.footprint.points)
      buff.write(_struct_I.pack(length))
      for val1 in self.goal.description.footprint.points:
        _x = val1
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
      buff.write(_struct_f.pack(self.goal.description.footprint.radius))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_12f.pack(_x.goal.description.kinematicModel.a_ux_ux, _x.goal.description.kinematicModel.a_ux_uy, _x.goal.description.kinematicModel.a_ux_w, _x.goal.description.kinematicModel.a_uy_ux, _x.goal.description.kinematicModel.a_uy_uy, _x.goal.description.kinematicModel.a_uy_w, _x.goal.description.kinematicModel.a_w_ux, _x.goal.description.kinematicModel.a_w_uy, _x.goal.description.kinematicModel.a_w_w, _x.goal.description.kinematicModel.a_g_ux, _x.goal.description.kinematicModel.a_g_uy, _x.goal.description.kinematicModel.a_g_w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.description.initialPose.x, _x.goal.description.initialPose.y, _x.goal.description.initialPose.theta,) = _struct_3d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      ...
      (self.goal.description.footprint.radius,) = _struct_f.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
