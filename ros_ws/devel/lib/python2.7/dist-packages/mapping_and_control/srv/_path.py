...
"""autogenerated by genpy from mapping_and_control/pathRequest.msg. Do not edit."""
import sys
...
class pathRequest(genpy.Message):
  ...
  _type = "mapping_and_control/pathRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mapping_and_control/pathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class pathResponse(genpy.Message):
  ...
  _type = "mapping_and_control/pathResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
bool status
...
class path(object):
  _type          = 'mapping_and_control/path'
