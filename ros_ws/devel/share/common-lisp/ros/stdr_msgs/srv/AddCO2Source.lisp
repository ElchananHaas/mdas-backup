...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddCO2Source-request>)))
  ...
  (cl:format cl:nil "stdr_msgs/CO2Source newSource~%~%================================================================================~%MSG: stdr_msgs/CO2Source~%# Source description~%~%string id~%float32 ppm~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddCO2Source-request)))
  "Returns full string definition for message of type 'AddCO2Source-request"
  (cl:format cl:nil "stdr_msgs/CO2Source newSource~%~%================================================================================~%MSG: stdr_msgs/CO2Source~%# Source description~%~%string id~%float32 ppm~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
