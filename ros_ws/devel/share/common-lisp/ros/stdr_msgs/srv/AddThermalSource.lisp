...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddThermalSource-request>)))
  ...
  (cl:format cl:nil "stdr_msgs/ThermalSource newSource~%~%================================================================================~%MSG: stdr_msgs/ThermalSource~%# Source description~%~%string id~%float32 degrees~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddThermalSource-request)))
  "Returns full string definition for message of type 'AddThermalSource-request"
  (cl:format cl:nil "stdr_msgs/ThermalSource newSource~%~%================================================================================~%MSG: stdr_msgs/ThermalSource~%# Source description~%~%string id~%float32 degrees~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
