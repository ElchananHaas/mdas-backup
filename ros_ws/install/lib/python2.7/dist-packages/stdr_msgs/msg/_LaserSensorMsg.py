...
float64 theta"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_4fiB3f.pack(_x.maxAngle, _x.minAngle, _x.maxRange, _x.minRange, _x.numRays, _x.noise.noise, _x.noise.noiseMean, _x.noise.noiseStd, _x.frequency))
      _x = self.frame_id
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.maxAngle, _x.minAngle, _x.maxRange, _x.minRange, _x.numRays, _x.noise.noise, _x.noise.noiseMean, _x.noise.noiseStd, _x.frequency,) = _struct_4fiB3f.unpack(str[start:end])
