...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CO2Source>)))
  ...
  (cl:format cl:nil "# Source description~%~%string id~%float32 ppm~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CO2Source)))
  "Returns full string definition for message of type 'CO2Source"
  (cl:format cl:nil "# Source description~%~%string id~%float32 ppm~%~%# sensor pose, relative to the map origin~%geometry_msgs/Pose2D pose ~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
