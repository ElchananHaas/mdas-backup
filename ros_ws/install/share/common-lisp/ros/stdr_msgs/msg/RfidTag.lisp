...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RfidTag>)))
  ...
  (cl:format cl:nil "# Rfid tag description~%~%string tag_id~%string message~%geometry_msgs/Pose2D pose # sensor pose, relative to the map origin~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RfidTag)))
  "Returns full string definition for message of type 'RfidTag"
  (cl:format cl:nil "# Rfid tag description~%~%string tag_id~%string message~%geometry_msgs/Pose2D pose # sensor pose, relative to the map origin~%~%================================================================================~%MSG: geometry_msgs/Pose2D~%# This expresses a position and orientation on a 2D manifold.~%~%float64 x~%float64 y~%float64 theta~%~%"))
